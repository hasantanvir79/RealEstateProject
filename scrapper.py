...
def toote_info(x):
    ...
    for n in links:
        ...
        try:
            ...
            if (driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/table/tbody/tr[6]/th').text=='Energiamärgis'):
                energymark.append(driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/table/tbody/tr[6]/td').text)            
                
            elif (driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/table/tbody/tr[7]/th').text=='Energiamärgis'):
                energymark.append(driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/table/tbody/tr[7]/td').text)
                
            elif (driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/table/tbody/tr[8]/th/a').text=='Energiamärgis'):
                energymark.append(driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/table/tbody/tr[8]/td').text)
                
            elif (driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/table/tbody/tr[9]/th/a').text=='Energiamärgis'):
                energymark.append(driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/table/tbody/tr[9]/td').text)

            elif (driver.find_element_by_xpath('/html/body/div[2]/div/div[2]/div[3]/div[2]/div/div[1]/table/tbody/tr[10]/th/a').text=='Energiamärgis'):
